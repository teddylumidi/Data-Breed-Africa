    ...
    return(
        ...
        <div className="row">
            <div className="col-6">
                ...
                <p className="lead">Feel free to get in touch with us for any inquiries or to discuss your data needs. Our team is here to assist you.</p>
            ...
            <div className="col-6">
                <h3 className="display-5">Send us a message</h3>
                <form>
